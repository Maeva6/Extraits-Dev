...
//CAS 2
// VERSION 1 (ligne 22) - A du code de débogage :
//console.log('Ingredient data:', response.data); // Ajoutez ceci pour vérifier les données

// VERSION 2 - Pas de console.log


//CAS 3
//3. Gestion de l'image COMPLÈTEMENT différente :
//VERSION 1 :

//Image affichée en bas, après les informations

//Utilise ingredient.photo directement

//Gestion d'erreur avec SVG inline

//VERSION 2 :

//Image affichée dans une colonne dédiée à gauche

//Utilise http://localhost:8000/storage/${ingredient.photo}

//Affiche "Aucune image disponible" si pas de photo


//CAS 4
//4. Structure du layout modifiée :
//VERSION 1 : Grille 1-1-1 (3 colonnes égales)
//VERSION 2 : Grille avec colonne photo dédiée


//CAS 5
//5. Code VERSION 1 problématique :
//jsx
// Double gestion d'image (potentiellement conflictuelle)
//{ingredient.photo && (
//  <div className="p-6 border-t bg-gray-50">
    {/* Section image en bas */}
//  </div>
//)}