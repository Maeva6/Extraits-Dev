        ...
        <div className="flex flex-col md:flex-row gap-10 items-start">
          <div className="flex w-full md:w-1/2 sticky top-28 self-start justify-center">
            <div className="bg-yellow-600 p-4 rounded-lg">
              ...
              />
              <h4 className="text-xl font-semibold text-black mb-2">Ingrédients clés :</h4>
      ...
      {product.ingredients.map((ingredient) => (
        <li key={ingredient.id} className="flex flex-col items-center w-16">
          <img
            ...
            className="w-12 h-12 object-cover items-center rounded-full border border-gray-300 shadow-sm"
          />
          <span className="text-[10px] text-center mt-1 text-black">{ingredient.nomIngredient}</span>
        </li>
      ))}
    </ul>
            </div>
